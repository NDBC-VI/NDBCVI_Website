...
export const ImageCarousel = ({images, next, prev, displayed, toolbarBottom = true, buttonsPosition = 'end', autoSlide = true, autoSlideInterval = 3000}: {images: SanityImageObject[], next: ()=>void, prev: ()=>void, displayed: number, toolbarBottom: boolean, buttonsPosition: string, autoSlide: boolean, autoSlideInterval: number}) => {
