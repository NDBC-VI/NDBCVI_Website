...
const Footer = () => {
  return (
    ...
    // <footer className="mt-0 flex flex-col md:flex-row md:h-[800px] lg:h-[800px] items-center md:items-start text-white bg-black">
    //   <div className="w-full h-full px-[20px] py-[50px] md:w-1/2 md:px-[60px] md:pt-[60px] bg-[#1D1841]">
    //     <div className="flex justify-between">
    //       <Image src={churchLogo} alt="Church logo" width={43} />
    //       <div className="flex gap-[24px]">
    //         <Image src={youtube} alt="Youtube icon" />
    ...
    //     </p>
    //   </div>
    //   <div className="md:w-1/2 h-full relative bg-blue-400">
